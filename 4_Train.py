...
for name in names:
    ...
    for idx, cat in enumerate(categories):
        ...
        label[idx] = 1
        image_dir = caltech_dir + name + "/" + cat
    ...
    np.save('./multi_image_data_' + name + '.npy', xy)
    ...
    X_train, X_test, y_train, y_test = np.load('./multi_image_data_' + name + '.npy', allow_pickle=True)
    print(X_train.shape)
    ...
    with K.tf_ops.device('/device:GPU:0'):
        ...
        model_path = model_dir + '/multi_img_classification_' + name + '.model'
